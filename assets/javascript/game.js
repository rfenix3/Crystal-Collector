...
$(document).ready(function() {
  ...
  // here we define the function that generates the random numbers
  var getNumbers = function(){
    ...
    firstNumber = generateRandom(1, 12);
  ...
  // here we call the getNumbers() function
  getNumbers();
...
// we will then create 4 imageCrystals
  ...
  // The function below will give each imageCrystal a data attribute called data-crystalValue.
  // This function also sets the data attribute equal to the random number generated by getNumbers().
